...
run_scripts() {
    ...
    CUDA_VISIBLE_DEVICES=$gpu_id python blender_obj_uv_normal.py --data_path ../logs/$obj --rotate_video --texture_type normal > output/${obj}_normal_rotate/rotate_video.log
